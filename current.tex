...
Our experiments demonstrate the superior efficiency of MIND compared to Pencil across various protocols and datasets. Figure \ref{subfig:ABY3}, \ref{subfig:Sphinx}, \ref{subfig:Chameleon}, and \ref{subfig:Quotient_2x512} show that for the MNIST dataset, MIND consistently requires less transmission and runtime across all four models (ABY3,  SPHINX,  Chameleon, and Quotient 2$\times$512).

Specifically, the MIND scheme demonstrates varying degrees of efficiency across different protocols. As shown in Figure \ref{subfig:ABY3}, ABY3 is the most efficient in reducing communication cost when applied to the ABY3 model and the most efficient in reducing runtime when applied to the Quotient 2$\times$512 model. Our experiments reveal that while the Pencil encryption scheme requires a communication cost of 1,933 MB, MIND only requires 1,008 MB, resulting in a significant reduction of approximately 49.42\% in communication cost. Additionally, MIND reduces the runtime by approximately 10.34\% compared to the Pencil scheme.

To further validate the efficiency of MIND, we found that compared to the Pencil scheme, MIND maintained lower communication and runtime in the CIFAR-10 dataset.

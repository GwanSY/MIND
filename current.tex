...
\begin{algorithm}[htbp]
	\caption{\PEnc$(\langle x \rangle_1,\langle x \rangle_2,w,b) \rightarrow (\langle y_j\rangle_1, \langle y_j\rangle_2)$}
    \label{alg:Parameter}
    \LinesNumbered
    ...
    \KwOut {Secret shares $\langle y_j \rangle_1 $ and $\langle y_j \rangle_2$.}
     ...
     $ED$ evaluates $\llbracket w_{j-1}\langle x \rangle_1 \rrbracket_{pk_s} = \llbracket w_{j-1} \rrbracket_{pk_s} \otimes \llbracket \langle x \rangle_1 \rrbracket_{pk_s}$;
    
     $ED$  calculates $\llbracket C\rrbracket_{pk_s} = \llbracket w_{j-1}\langle x \rangle_1 \rrbracket_{pk_s} \oplus \llbracket r_1 \rrbracket_{pk_s}$;
     
     $ED$ sends $\llbracket C\rrbracket_{pk_s}$ back to $S$;
    
     $S$ decrypts $\llbracket C\rrbracket_{pk_s}$ to get $w_{j-1}\langle x \rangle_1 + r_1$;
     
     $ED$ obtains $\langle y_p\rangle_1=-r_{j-1}$ and $S$ obtains $\langle y_p\rangle_2 = w_{j-1} x  + b_{j-1} + r_1$.
\end{algorithm}
